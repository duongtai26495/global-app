...
const ResultContent = () => {
    ...
    const RenderResult = () => {
            ...
            return (
                ...
                (
                    <div key={index} className={`w-full flex flex-col gap-2 my-2`}>
                        <p className={`text-2xl m-auto font-bold ${color_theme}`}>{nativeName[key].official}</p>
                        <span className={`text-xl m-auto font-bold ${color_theme}`}>( {nativeName[key].common} )</span>
                    </div>
                )
                )
            )
        ...
        return (
            <div className={`w-full flex flex-col xl:flex-row gap-3 mt-3`}>
                <div className='w-full flex flex-col gap-3'>
                    <div className={`w-full h-fit flex flex-row gap-2 p-2 bg-opacity-80 md:bg-opacity-100 rounded-md relative ${localDarkmode === DARK ? "out-box-effect bg-zinc-800" : "bg-slate-50 in-box-effect shadow-md"}`}>
                    ...
                    <div className={`w-full flex flex-col p-2 gap-2 bg-opacity-80 md:bg-opacity-100 rounded-md ${localDarkmode === DARK ? "out-box-effect bg-zinc-800" : "bg-slate-50 in-box-effect"}`}>
                        <RenderName />
                        <div className='w-full border border-zinc-500 rounded py-1 px-2'>
                            <p className={`text-md italic mb-2 ${color_theme}`}>General:</p>

                            <div className={`w-full flex flex-col justify-start gap-2 p-2 nationInfor`}>
                        ...
                        <div className='w-full border border-zinc-500 rounded p-1 px-2'>
    ...
    return (
        <div className={`w-full h-full flex flex-col p-3 lg:p-0 gap-3`}>
            {
                page_loading === false ?
