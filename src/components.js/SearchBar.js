    ...
    return (
        <div className={`bg-transparent w-full flex flex-col gap-2`}>
            <div className='w-full flex flex-row items-center relative gap-2'>
                ...
                <SelectType />
                <div className={`{ ${type !== "name" ? "hidden" : "hidden lg:flex" } w-fit h-10 p-1 justify-end flex-row gap-2 items-center ${localDarkmode === LIGHT ? "light-checkbox-effect" : "dark-checkbox-effect"}  ${isFullText == true ? "bg-teal-400" : "" }`}>
                <SearchFullText />
                </div>
                <button onClick={() => handleSearch()} className={`w-fit p-1 ${localDarkmode === LIGHT ? "light-box-effect" : "dark-box-effect"} `}>
            ...
            <div className={`${type !== "name" ? "hidden" : "lg:hidden flex" } w-fit h-10 p-1 justify-end flex-row gap-2 items-center ${localDarkmode === LIGHT ? "light-checkbox-effect" : "dark-checkbox-effect"}  ${isFullText == true && "bg-teal-400 " }`}>
                <SearchFullText />
            </div>
        </div>
    )
